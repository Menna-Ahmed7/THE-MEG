...
namespace our
{
  ...
  void World::deserialize(const nlohmann::json &data, Entity *parent)
  {
    ...
    {
      // TODO: (Req 8) Create an entity, make its parent "parent" and call its
      // deserialize with "entityData".
      ...
      if (entityData.contains("children"))
      {
        ...
        const nlohmann::json &childrenData = entityData["children"];
        deserialize(childrenData, newEntity);
      }
    }
  }
