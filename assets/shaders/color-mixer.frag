...
void main(){
    frag_color.r = dot(red,vec4(fs_in.color,1.0)); //red
    frag_color.g = dot(green,vec4(fs_in.color,1.0)); //green
    frag_color.b = dot(blue,vec4(fs_in.color,1.0)); //blue
    frag_color.a = 1.0; //alpha (always 1)
}